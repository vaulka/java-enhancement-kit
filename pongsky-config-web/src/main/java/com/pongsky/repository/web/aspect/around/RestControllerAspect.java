package com.pongsky.repository.web.aspect.around;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.pongsky.repository.config.StorageConfig;
import com.pongsky.repository.utils.IpUtils;
import com.pongsky.repository.utils.ReflectUtils;
import com.pongsky.repository.utils.desensitization.DesensitizationMark;
import com.pongsky.repository.utils.storage.StorageResourceMark;
import com.pongsky.repository.web.request.RequestUtils;
    ...
    public Object exec(ProceedingJoinPoint point) throws Throwable {
        ...
        switch (requestMethod) {
            ...
            case DELETE:
                ...
                log.info("request: uri [{}] method [{}] params [{}] body [{}]",
